package com.example.jwt_practices.jwt;

import com.example.jwt_practices.model.entity.AppUser;
...
public class JwtService {
    ...
    public static final String SECRET = "Kf9#Lm2@Qx8!zR5$uT7&bN1*wY6^cD3pA0sV4!eR9";
